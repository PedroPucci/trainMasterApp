...
//import CourseDetailScreen from "../../screens/CourseDetailScreen"; // tela de detalhe (fica "escondida" na aba)
...
export type TabParamList = {
  ...
  Buscar: undefined;
  Menu: undefined; // item especial que abre um modal de menu
};
...
type BuscarStackParamList = {
  BuscarHome: undefined;               // tela de busca
