...
//       case "name":
//         return required(name, "Nome completo");
//       case "email":
...
//     } catch (e: any) {
//       const msg = e?.response?.data?.message || "Não foi possível registrar.";
...
//   const payload = {
//     cpf: cpf.replace(/\D/g, ""),    // tira máscara
//     name: name.trim(),
//     email: email.trim(),
//     password: password,
//   };
...
//     if (!res.ok) {
//       // trate 409 (duplicado) e 400
//       const msg =
//         data?.message ||
//         (res.status === 409 ? "CPF ou e-mail já cadastrados." :
...
//           <Text style={s.registerLink} onPress={() => navigation?.navigate?.("Entrar")}> Realizar Login</Text>
//         </Text>
//       </ScrollView>
//     </KeyboardAvoidingView>
//   );
