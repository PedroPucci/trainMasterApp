...
// //       }));
// //     } catch (e: any) {
// //       const msg = e?.message === "Tempo limite excedido" ? "Conexão lenta/instável. Tente novamente." : "Não foi possível carregar o perfil.";
...
// //     } catch (e: any) {
// //       const msg = e?.message === "Tempo limite excedido" ? "Conexão lenta/instável. Tente novamente." : "Não foi possível salvar as informações.";
// //       Alert.alert("Erro de conexão", msg);
// //     } finally {
// //       setSaving(false);
// //     }
...
//     >
//       <Text
//         style={[s.pickerValueText, { color: value ? hardText : hardMuted }]}
//         numberOfLines={1}
//       >
//         {value || placeholder}
//       </Text>
...
//               style={[
//                 s.input,
//                 { backgroundColor: hardBg, color: hardText, borderColor: hardBorder },
...
export default function ProfileScreen() {
  ...
  // estilos dinâmicos para deixar os campos limpos no dark
  const wrapOverride = {
    backgroundColor: "transparent",
    borderWidth: 1,
    borderColor: hardBorder,
  ...
  const inputOverride = {
    ...
    color: hardText,
    borderColor: hardBorder,
    borderWidth: 0, // a borda fica no wrapper
  } as const;
